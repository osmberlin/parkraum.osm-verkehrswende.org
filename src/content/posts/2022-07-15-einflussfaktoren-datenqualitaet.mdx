...
- <strong class="rounded bg-stone-200 px-1 py-0 font-mono font-semibold">1</strong> Diese Abweichung
  ist größer als die Summe der Abweichungen der einzelnen Features, da ein durch ein bestimmtes
  Feature vom Parken „freigehaltener“ Bereich auch von anderen Features umfasst sein kann.
- <strong class="rounded bg-stone-200 px-1 py-0 font-mono font-semibold">2</strong> Werden nur die
  separat gemappten Linienabschnitte allein betrachtet, würde ohne separate Kartierweise eine
  Überschätzung von 32% der Stellplätze entstehen (1.312 Stellplätze mit, 1.738 ohne separates
  Mapping).
- <strong class="rounded bg-stone-200 px-1 py-0 font-mono font-semibold">3</strong> Straßenbreiten
  sind zum Testzeitpunkt nur an 40 Prozent des Straßennetzes im Testgebiet gemappt. Werden nur die
  Straßen mit gemappter Breite verglichen, wird die Stellplatzzahl um etwa 1 Prozent unterschätzt.
- <strong class="rounded bg-stone-200 px-1 py-0 font-mono font-semibold">4</strong> Breite von
...
- <strong class="rounded bg-stone-200 px-1 py-0 font-mono font-semibold">5</strong> Nur auf die
