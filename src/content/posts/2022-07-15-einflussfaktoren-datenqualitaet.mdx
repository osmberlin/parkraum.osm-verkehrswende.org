  ...
  <table class="md:mt-0">
    ...
    <tbody>
      ...
      <tr class="bg-stone-50">
        <th class="py-2 pl-3 align-baseline leading-tight">
          alle oben genannten
          <span class="rounded bg-stone-100 py-0 px-1 font-mono font-semibold">1</span>
        </th>
      ...
      <tr>
        <th class="py-2 pl-3 align-baseline leading-tight">
          ...
          <span class="rounded bg-stone-100 py-0 px-1 font-mono font-semibold">2</span>
        </th>
      ...
      <tr>
        <th class="py-2 pl-3 leading-tight">
          Fahrbahnbreite
          <span class="rounded bg-stone-100 py-0 px-1 font-mono font-semibold">3</span>
        </th>
      ...
      <tr>
        <th class="py-2 pl-3 align-baseline leading-tight">
          ...
          <span class="rounded bg-stone-100 py-0 px-1 font-mono font-semibold">4</span>
        </th>
      ...
      <tr>
        <th class="py-2 pl-3 align-baseline leading-tight">
          ...
          <span class="rounded bg-stone-100 py-0 px-1 font-mono font-semibold">5</span>
        </th>
...
- <strong class="rounded bg-stone-200 py-0 px-1 font-mono font-semibold">1</strong> Diese Abweichung
...
- <strong class="rounded bg-stone-200 py-0 px-1 font-mono font-semibold">2</strong> Werden nur die separat
...
- <strong class="rounded bg-stone-200 py-0 px-1 font-mono font-semibold">3</strong> Straßenbreiten sind
...
- <strong class="rounded bg-stone-200 py-0 px-1 font-mono font-semibold">4</strong> Breite von Einfahrten
...
- <strong class="rounded bg-stone-200 py-0 px-1 font-mono font-semibold">5</strong> Nur auf die separat
