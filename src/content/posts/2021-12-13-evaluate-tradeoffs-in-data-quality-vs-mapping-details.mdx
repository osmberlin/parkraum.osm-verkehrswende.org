...
pubDate: 2021-12-13 06:00:00 +0100
author: Tobias Jordans @tordans
description: Let's convince administrations of the data quality created by the OSM community.
imagePath: /images/posts/parkstreifen-generieren.png
imageAlt: Parking map with debugging circles to show different cutoff areas.
...
<ImageWrapper
  src="/images/posts/parkstreifen-generieren.png"
  alt="Parking map (OSM) with debugging circles to show different cutoff areas."
/>
...
<ImageWrapper
  src="/images/posts/parkstreifen-generieren.png"
  alt="Parking map (OSM) with debugging circles to show different cutoff areas."
  caption="Screenshot of the parking map with debugging circles to show different cutoff areas."
/>
