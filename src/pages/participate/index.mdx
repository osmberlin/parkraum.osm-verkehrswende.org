...
<Notice colorClass="bg-orange-100" className="my-10">
  <strong>Dieses Projekt ist noch im Aufbau!</strong>
  <br />
  Im Laufe der kommenden Zeit werden wir hier Anleitungen und Hinweise zu Editoren und Tools
  veröffentlichen, um Parkraumdaten in OSM zu erheben.
</Notice>
